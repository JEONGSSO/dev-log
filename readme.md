...
| 제목                                                                                                                                                       | 내용                                                         | 업데이트 날짜 |
| ---------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------ | ------------- |
| [DEVELOPER] [TDD](https://github.com/JEONGSSO/dev-log/blob/master/js/도서/test-Driven-Development/3.모두를_위한_평등.md)                                   | test-driven-devlopment 정리 3장                              | 21/12/16      |
| [SQL] [single, composite index](https://github.com/JEONGSSO/dev-log/blob/master/sql/sql_index.md)                                                          | single, composite index 비교                                 | 21/12/13      |
...
| [DEVELOPER] [TDD](https://github.com/JEONGSSO/dev-log/blob/master/js/도서/test-Driven-Development/2.타락한_객체.md)                                        | test-driven-devlopment 정리 2장                              | 21/11/30      |
...
| [JS] [구름 구구단+ 풀이](https://github.com/JEONGSSO/dev-log/blob/master/js/문제풀이/groom/구구단+.js)                                                     | 구름 구구단+                                                 | 21/04/18      |
...
| [JS] [DFS BFS 정리](https://github.com/JEONGSSO/dev-log/blob/master/알고리즘/DFS_BFS.md)                                                                   | DFS, BFS 정리                                                | 21/04/15      |
...
| [JS] [백준 더하기 사이클](https://github.com/JEONGSSO/dev-log/blob/master/js/문제풀이/백준/1110_더하기_사이클.js)                                          | 백준 1110 더하기 사이클                                      | 21/03/23      |
...
| [DEVELOPER] [시간복잡도](https://github.com/JEONGSSO/dev-log/blob/master/알고리즘/시간복잡도_bigO.md)                                                      | 시간복잡도 정리                                              | 21/02/24      |
...
| [LINUX(WSL)] [wsl에서 jetbrains idea 사용하기](<https://github.com/JEONGSSO/dev-log/blob/master/linux(wsl)/wsl2_개발환경_구축#intellij-idea-with-wsl2.md>) | wsl에서 jetbrains idea 설치 및 사용 추가                     | 21/01/07      |
